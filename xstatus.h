...
#define XST_DMA_SG_COUNT_EXCEEDED       521L	/*!< The packet count threshold scatter gather list */
...
#define XST_IPIF_DEVICE_ID_ERROR        540L	/*!< The device interrupt ID register did not indicate the expected alue */
...
#define XST_FLASH_ERROR               1128L	/*!< Flash had detected an internal error. Use XFlash_DeviceControlto retrieve device specific codes */
...
#define XST_OPBARB_INVALID_PRIORITY  1176	/*!< the priority registers have eitherone master assigned to two or more priorities, or one master not assigned to any priority */
